  ...
  return (
    <div className="space-y-5">
      <div className="grid grid-cols-3 gap-5">
        {[
          { label: "Servicios Hoy", value: String(serviciosHoy), color: "text-[#0da766]" },
          { label: "Técnicos Activos", value: String(tecnicosActivos), color: "text-[#0da766]" },
          { label: "Alertas", value: String(serviciosPendientes), color: "text-red-500" },
        ].map((kpi, i) => (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
          ...
          <div className="space-y-3">
            ...
            >
              ...
              <p className="text-3xl font-black">{serviciosCompletados}</p>
            </button>
            ...
            >
              ...
              <p className="text-3xl font-black">{serviciosPendientes}</p>
            </button>
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
          ...
          <div className="space-y-2 overflow-y-auto max-h-[320px]">
            {tecnicos.length === 0 && (
              <p className="text-center text-gray-400 py-8 text-sm">Cargando técnicos...</p>
            )}
            {tecnicos.map((t) => (
