...
<body>
    ...
    <div class="dashboard-wrapper">
        <nk-sidebar role="tech" active="solicitar" context="${pageContext.request.contextPath}"></nk-sidebar>
                        ...
                        <form id="materialForm" onsubmit="return submitMaterial(event)">
                            <div class="row g-4">
                                <div class="col-md-8">
                                    ...
                                    <input type="text" id="matName" class="form-control bg-light border-0 py-2 px-3 shadow-none rounded-3" placeholder="Ej. Rollo de Cable 12AWG" required minlength="3" maxlength="150">
                                    <div class="invalid-feedback"></div>
                                </div>
                                
                                <div class="col-md-4">
                                    <label class="form-label text-muted fw-bold fs-13">Cantidad Necesaria</label>
                                    <input type="number" id="matQty" class="form-control bg-light border-0 py-2 px-3 shadow-none rounded-3" value="1" min="1" max="9999" required>
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea id="matJustification" class="form-control bg-light border-0 py-3 px-3 shadow-none rounded-3" rows="3" placeholder="Explique brevemente por qué requiere estos materiales..." maxlength="500"></textarea>
                                </div>
